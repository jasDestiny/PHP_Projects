...
$com=mysqli_query($con,"select * from stcccs where regno='$c' or mail='$b' or phno='$d';");

$count=mysqli_num_rows($com);

if($count==0)
{
	$com=mysqli_query($con,"insert into stcccs values('$a','$b','$c','$d','$e','0');");
